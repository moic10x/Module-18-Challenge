...
# YOUR CODE HERE
sender_id = st.text_input("Please specify sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
receiver_id = st.text_input("Please specify receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE

input_amount = st.number_input("Please specify amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender = sender_id, receiver= receiver_id, amount = input_amount),
        creator_id=42,
